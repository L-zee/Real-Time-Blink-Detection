...
while cap.isOpened():
    ...
    for face in faces:
        ...
        # 计算左眼状态文本的位置
        state_pos_l = (eye_rect_l[0]+2, eye_rect_l[1]-6)
        # 计算右眼状态文本的位置
        state_pos_r = (eye_rect_r[0]+2, eye_rect_r[1]-6)
        
        # 计算左眼概率文本的位置
        prob_pos_l = (eye_rect_l[0]-10, eye_rect_l[3]+18)
        # 计算右眼概率文本的位置
        prob_pos_r = (eye_rect_r[2]-25, eye_rect_r[3]+18)
